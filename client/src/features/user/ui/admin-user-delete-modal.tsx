    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>선택한 사용자를 영구적으로 삭제합니다.</DialogDescription>
        </DialogHeader>

        <div className="flex items-start gap-3 p-4 bg-red-50 rounded-md">
          <AlertTriangle className="w-5 h-5 shrink-0 text-red-600 mt-0.5" />
          <div>
            <p className="text-sm font-medium text-red-800">'{user.name}' 사용자를 삭제하시겠습니까?</p>
            <p className="text-sm text-red-700 mt-1">이 작업은 되돌릴 수 없습니다.</p>
          </div>
        </div>
